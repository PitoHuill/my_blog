...
type UIStrings = {
  ...
  search: { title: string; description: string; inputLabel: string; placeholder: string; initialMessage: string; results: string; noResults: string };
...
export const ui: Record<Locale, UIStrings> = {
  en: {
    ...
    search: { title: 'Search posts', description: 'Search posts', inputLabel: 'Enter a keyword', placeholder: 'Title, description, or tag', initialMessage: 'Enter a keyword to start searching', results: 'posts found', noResults: 'No posts found' },
  ...
  zh: {
    ...
    search: { title: '搜索文章', description: '搜索文章', inputLabel: '输入关键词', placeholder: '标题、摘要或标签', initialMessage: '输入关键词开始搜索', results: '篇文章', noResults: '没有找到文章' },
